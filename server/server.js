...
// Pre-initialize local files with seed data if they don't exist
        ...
        <div style="background-color: #faf9fc; padding: 40px 20px; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;">
          <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 20px; overflow: hidden; box-shadow: 0 10px 30px rgba(79, 70, 229, 0.05); border: 1px solid #f1eff5;">
            ...
            <div style="padding: 45px 35px;">
              ...
              <p style="color: #615a75; font-size: 15px; line-height: 1.6; margin-bottom: 24px;">Hi <strong>${order.customer.name}</strong>,</p>
              <p style="color: #615a75; font-size: 15px; line-height: 1.6; margin-bottom: 30px;">
              ...
              <div style="background: #faf9fc; border: 1.5px solid #e1dde6; padding: 20px; border-radius: 12px; margin-bottom: 30px; text-align: center;">
                <span style="display: block; font-size: 10px; font-weight: 800; color: #10b981; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 4px;">Delivery Company</span>
                <strong style="display: block; font-size: 18px; color: #2d2645; margin-bottom: 16px;">${order.deliveryCompany}</strong>
                <span style="display: block; font-size: 10px; font-weight: 800; color: #10b981; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 4px;">Tracking Reference ID</span>
                <strong style="display: block; font-size: 20px; font-family: monospace; color: #2d2645; background: #ffffff; padding: 8px 15px; border-radius: 8px; border: 1px solid #f1eff5; display: inline-block;">${order.deliveryReference}</strong>
              </div>
            ...
            <div style="background-color: #faf9fc; padding: 25px 35px; border-top: 1px solid #f1eff5; text-align: center;">
              <p style="font-size: 11px; color: #b4afc4; margin: 0;">© 2026 Lolly Shop New Zealand. All rights reserved.</p>
            </div>
          </div>
        </div>
      `
...
// helper to send delivery complete email
...
app.put('/api/orders/:id/delivery', (req, res) => {
  try {
...
app.put('/api/orders/:id/remove-item', (req, res) => {
  try {
...
app.put('/api/orders/:id/feedback', (req, res) => {
  try {
        ...
        <div style="background-color: #faf9fc; padding: 40px 20px; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;">
          <div style="max-width: 560px; margin: 0 auto; background-color: #ffffff; border-radius: 20px; overflow: hidden; box-shadow: 0 10px 30px rgba(79, 70, 229, 0.05); border: 1px solid #f1eff5;">
            ...
            <div style="padding: 40px 35px;">
              ...
              <p style="color: #615a75; font-size: 15px; line-height: 1.6; margin-bottom: 24px;">Hi <strong>${userDetails.name}</strong>,</p>
              <p style="color: #615a75; font-size: 15px; line-height: 1.6; margin-bottom: 30px;">
              ...
              <div style="text-align: center; margin: 35px 0;">
                <a href="${resetLink}" style="background: linear-gradient(135deg, #e72c83 0%, #a855f7 100%); color: #ffffff; padding: 16px 36px; border-radius: 50px; font-weight: 700; font-size: 15px; text-decoration: none; display: inline-block; box-shadow: 0 6px 20px rgba(231, 44, 131, 0.4); text-transform: uppercase; letter-spacing: 0.8px;">
                  Reset Password
                </a>
              </div>
...
if (process.env.NODE_ENV !== 'production') {
  app.listen(PORT, () => {
    console.log(`Express server running on port ${PORT} (local JSON file storage mode)`);
  });
}
